...
const Index = () => {
  const { data: antiques, isLoading, error } = useAntiques();
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Découvrez notre collection d'antiquités et objets de charme sélectionnés avec passion à Bulle, Suisse. Pièces uniques pour votre intérieur et jardin."
        />
      </Helmet>
          ...
          <div className="container relative">
            <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
                Une sélection raffinée de pièces anciennes et objets de charme, 
                choisis avec passion pour sublimer votre intérieur et votre jardin.
              </p>
            </div>
          </div>
        </section>
                ...
                {antiques.map((antique, index) => (
                  ...
                  >
                    <AntiqueCard
                      ...
                      price={Number(antique.price)}
                      imageUrl={antique.image_url}
                    />
                  </div>
                ))}
              </div>
